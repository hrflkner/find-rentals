...
export default function PropertyDetails({ property }: Props) {
  return (
    <main>
      <div className="bg-gray-800 p-6 rounded-lg shadow-md text-center md:text-left">
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-md mt-6">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 list-none gap-y-2">
          {property.amenities.map((amenity, idx) => {
            return (
              <li key={idx}>
                <FaCheck className="inline text-green-600 mr-2 mb-1" />
                {amenity}
              </li>
            )
          })}
