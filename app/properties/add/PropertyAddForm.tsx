...
export default function PropertyAddForm() {
  ...
  return (
    <form action="/api/properties" method="POST" encType="multipart/form-data">
      ...
      <div className="mb-4">
        <label htmlFor="images" className="block text-blue-400 font-light mb-2">
        ...
        <input
          ...
          id="images"
          name="images"
          className="bg-gray-900 border rounded w-full py-2 px-3 file:bg-black file:text-white file:rounded-md file:border-none file:py-2 file:px-4 file:cursor-pointer file:hover:bg-blue-900/60"
          accept="image/*"
          multiple
